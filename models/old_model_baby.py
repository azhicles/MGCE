...
class Model(object):
    ...
    def __init__(self, data_config, img_feat, text_feat, pop_feat, d1, d2):
        ...
        self.batch_ratings = tf.matmul(self.u_g_embeddings, self.pos_i_g_embeddings,
                             ...
                             lambda_m*tf.matmul(self.u_g_int_embeddings_v, self.pos_i_g_int_embeddings_v,
                                       transpose_a=False, transpose_b=True) + \
                             lambda_m*tf.matmul(self.u_g_con_embeddings_v, self.pos_i_g_con_embeddings_v,
                                       transpose_a=False, transpose_b=True) + \
                             tf.matmul(self.u_g_int_embeddings_t, self.pos_i_g_int_embeddings_t,
                                       transpose_a=False, transpose_b=True) + \
                             tf.matmul(self.u_g_con_embeddings_t, self.pos_i_g_con_embeddings_t,
                                       transpose_a=False, transpose_b=True)
